...
def choose_position():
    ...
    while True:
        ...
        if p1[1] == p1[5] == p1[-2] == 'X' or p3[1] == p3[5] == p3[-2] == 'X' or p5[1] == p5[5] == p5[-2] == 'X' or p1[1] == p3[1] == p5[1] == 'X' or p1[3] == p3[3] == p5[3] == 'X' or p1[-2] == p3[-2] == p5[-2] == 'X' or p1[1] == p3[5] == p5[-2] == 'X' or p1[-2] == p3[5] == p5[1] == 'X':
            print('Player X win')
            ...
            while True:
                ...
                if play_again == 'Y':
                    ...
                    continue
        elif p1[1] == p1[5] == p1[-2] == 'O' or p3[1] == p3[5] == p3[-2] == 'O' or p5[1] == p5[5] == p5[-2] == 'O' or p1[1] == p3[1] == p5[1] == 'O' or p1[3] == p3[3] == p5[3] == 'O' or p1[-2] == p3[-2] == p5[-2] == 'O' or p1[1] == p3[5] == p5[-2] == 'O' or p1[-2] == p3[5] == p5[1] == 'O':
            print('Player O win')
